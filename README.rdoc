...
=== Ruby code
  ...
  # Generates Invalid CPFs
  Faker::CPFInvalid.numeric    #=> "12345678901"
  Faker::CPFInvalid.pretty     #=> "123.456.789-01"

  # Generates CNPJ
  Faker::CNPJ.numeric    #=> "31669138588095"
  Faker::CNPJ.pretty     #=> "69.068.788/8492-00"

  # Generates Invalid CNPJ
  Faker::CNPJInvalid.numeric    #=> "12345678901234"
  Faker::CNPJInvalid.pretty     #=> "12.345.678/9012-34"
...
The command line executables are ridiculously simple and do nothing besides printing and coping number-only cpfs and cnpjs.
  ...
  $ cpf_invalid
  12345678901
  Invalid CPF Copied to your clipboard!
  ...
  $ cnpj_invalid
  12345678901234
  Invalid CNPJ Copied to your clipboard!
